...
from scrstudio.configs.base_config import InstantiateConfig, LoggingConfig, MachineConfig, ViewerConfig
from scrstudio.configs.config_utils import to_immutable_dict
from scrstudio.engine.optimizers import OptimizerConfig
from scrstudio.engine.schedulers import SchedulerConfig
...
class ExperimentConfig(InstantiateConfig):
    ...
    project_name: Optional[str] = "scrstudio-project"
    """Project name."""
    ...
    relative_model_dir: Path = Path("scrstudio_models/")
    ...
    def get_base_dir(self) -> Path:
        ...
        return Path(f"{self.output_dir}/{self.experiment_name}/{self.method_name}/fixed")
